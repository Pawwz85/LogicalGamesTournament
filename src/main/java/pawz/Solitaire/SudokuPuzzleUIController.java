...
import pawz.Solitaire.CLI.BasicCommandHandler;
import pawz.Solitaire.CLI.BasicCommandHandlerBuilder;
import pawz.Solitaire.CLI.NotEnoughArgumentsException;
...
public class SudokuPuzzleUIController {
    ...
    public void displayHelp(){
        ...
        model.setAdditionalText(stringBuilder.toString());
    }
