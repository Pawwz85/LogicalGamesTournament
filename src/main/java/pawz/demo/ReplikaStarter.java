...
public class ReplikaStarter {
    ...
    public Optional<TournamentSystem<SudokuMove, SudokuState>> getBootedReplika(){
        try {
            ...
            TournamentSystem<SudokuMove, SudokuState> result = new TournamentSystem<>(puzzleRepository, ticketRepository, gameDefinition);
