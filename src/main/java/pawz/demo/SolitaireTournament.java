...
public class SolitaireTournament {
    ...
    private class DeclarationManager implements ISolutionDeclarationManager<SudokuMove>{
        ...
        private final PuzzleSolutionDigester<SudokuMove> digester = new PuzzleSolutionDigester<>();
    ...
    public SolitaireTournament(IPuzzleSolutionTicketService<SudokuMove, SudokuState> service, IServiceSession session) {
        ...
        this.tickets = new ArrayList<>(service.getAllOwnedTickets(session));
    ...
    private void handleCommand(String[] args, Map<String, String> kwargs) throws NotEnoughArgumentsException {
        ...
        if(!puzzleUIController.tryExecute(args, kwargs))
            help();
    ...
    private void help(){
        ...
        for(var commandHandler: commandHandlers)
            System.out.println(commandHandler.getShortHelpString());

        System.out.println(puzzleUIController.getHelp());
        System.out.println("\nType [command] -help or [command] -man for more info");
    }
    ...
    private void initCommandHandlers() {
        ...
        BasicCommandHandler declare = builder.withKeywordMatcher("declare")
                ...
                .withShortHelp("Usage:\tdeclare")
                .withLongHelp("The usage of this command is very simple, it is just\n\tdeclare\n\tCommand above will mark given puzzle as complete, and proceed to next puzzle if possible, or proceed to final results")
                .build();
        ...
        BasicCommandHandler commit = builder.withKeywordMatcher("commit")
                        ...
                        .withLongHelp("The usage of this command is:\n\tcommit")
