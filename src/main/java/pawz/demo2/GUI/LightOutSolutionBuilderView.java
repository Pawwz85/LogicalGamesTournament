...
public class LightOutSolutionBuilderView implements Component.ComponentObserver<SolutionBuilderFrame<LightOutMove, LightOutState>> {
    ...
    private Rectangle createRectangle(int i, SolutionBuilderFrame<LightOutMove, LightOutState> frame){
        ...
        Color paint =  (frame == null || frame.currentState.board[i] == 0)? lightOff : lightOn;
    ...
    private void render(SolutionBuilderFrame<LightOutMove, LightOutState> frame){
